...
fn compare(registers: &mut registers::Registers, v: u8) {
...
fn sub(registers: &mut registers::Registers, v: u8) {
    let a = registers.get8(&registers::Registers8::A);
    let n = a.wrapping_sub(v);
...
fn add(registers: &mut registers::Registers, v: u8) {
    let a = registers.get8(&registers::Registers8::A);
...
fn pop_stack(registers: &mut registers::Registers, mmu: &mut mmu::MMU, r: &registers::Registers16) {
    let sp = registers.get16(&registers::Registers16::SP);
    let v = mmu.get16(sp);
    registers.set16(r, v);
    registers.set16(&registers::Registers16::SP, sp + 2);
...
pub fn new() -> Instructions {
    ...
    instructions[0x0002] = Op::Load8(
        Load8Args::Mem(registers::Registers16::BC),
        Load8Args::R(registers::Registers8::A),
    );
    ...
    instructions[0x001A] = Op::Load8(
        Load8Args::R(registers::Registers8::A),
        Load8Args::Mem(registers::Registers16::DE),
    );
    ...
    instructions[0x004F] = Op::Load8(
        Load8Args::R(registers::Registers8::C),
        Load8Args::R(registers::Registers8::A),
    );
    instructions[0x0057] = Op::Load8(
        Load8Args::R(registers::Registers8::D),
        Load8Args::R(registers::Registers8::A),
    );
    instructions[0x0067] = Op::Load8(
        Load8Args::R(registers::Registers8::H),
        Load8Args::R(registers::Registers8::A),
    );
    instructions[0x0076] = Op::Halt;
    instructions[0x0077] = Op::Load8(
        Load8Args::Mem(registers::Registers16::HL),
        Load8Args::R(registers::Registers8::A),
    );
    instructions[0x0078] = Op::Load8(
        Load8Args::R(registers::Registers8::A),
        Load8Args::R(registers::Registers8::B),
    );
    instructions[0x007B] = Op::Load8(
        Load8Args::R(registers::Registers8::A),
        Load8Args::R(registers::Registers8::E),
    );
    ...
    instructions[0x007D] = Op::Load8(
        Load8Args::R(registers::Registers8::A),
        Load8Args::R(registers::Registers8::L),
    );
